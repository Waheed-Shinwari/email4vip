...
sendDocEmail("kokotest94@gmail.com","testgmail","kokotest94@gmail.com","Hello dot pdf");
...
void CreateEmailFile(char *From,char *To,char *Subject)
 ...
 char *pdfFileName=getDocName("./send_pdf");
